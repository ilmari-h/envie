...
CREATE TABLE "environment_variable_groups" (
	"required_by_environment_version_id" text NOT NULL,
...
ALTER TABLE "environment_variable_groups" ADD CONSTRAINT "environment_variable_groups_required_by_environment_version_id_environment_versions_id_fk" FOREIGN KEY ("required_by_environment_version_id") REFERENCES "public"."environment_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "environment_variable_groups" ADD CONSTRAINT "environment_variable_groups_variable_group_id_variable_groups_id_fk" FOREIGN KEY ("variable_group_id") REFERENCES "public"."variable_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
