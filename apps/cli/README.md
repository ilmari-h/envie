...
- `envie set <organization-name:project-name:env-name> <key=value>` - Set an environment variable
- `envie unset <organization-name:project-name:env-name> <key=value>` - Set and enviornment variable
